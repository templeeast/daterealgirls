...
const sections = [
  ...
  },
  {
    ...
    color: 'text-cyan-600',
    items: [
      { id: 'vid-1', label: 'ADMIN SETTINGS: "Enable Videos for Private Photos" toggle saves to SiteConfig (videos_private_enabled) and persists on reload' },
      { id: 'vid-2', label: 'ADMIN SETTINGS: "Enable Videos for Chat" toggle saves to SiteConfig (videos_chat_enabled) and persists on reload' },
      ...
      { id: 'vid-9', label: 'PRIVATE UPLOAD: When videos_private_enabled is OFF, file picker only accepts images (accept="image/*")' },
      { id: 'vid-10', label: 'PRIVATE UPLOAD: When videos_private_enabled is ON, file picker accepts both images and videos (accept="image/*,video/*")' },
      ...
      { id: 'vid-16', label: 'PRIVATE UPLOAD: Description text changes to mention videos when videos_private_enabled is ON' },
      { id: 'vid-17', label: 'PRIVATE UPLOAD: Upload button text changes to "Upload Private Photo/Video" when videos_private_enabled is ON' },
      ...
      { id: 'vid-29', label: 'CHAT: When videos_chat_enabled is ON, video upload button (VideoIcon) appears next to image button' },
      { id: 'vid-30', label: 'CHAT: When videos_chat_enabled is OFF, video upload button is hidden' },
      { id: 'vid-31', label: 'CHAT: Video cost hint shows in composer area when videos_chat_enabled is ON' },
      ...
      { id: 'vid-53', label: 'i18n: private_photos_videos_desc shows when videos_private_enabled is ON, replacing the standard private_photos_desc' },
    ],
  },
];
