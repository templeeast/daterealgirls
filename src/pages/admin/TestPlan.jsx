...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'ep-62', label: 'REDEMPTION (purchase): Male user applying a female-only purchase promo at checkout gets "not available for your gender" error' },
      { id: 'ep-63', label: 'REDEMPTION (purchase): Female user applying a male-only purchase promo at checkout gets "not available for your gender" error' },
      { id: 'ep-64', label: 'REDEMPTION (purchase): Male user applying a male-only purchase promo at checkout succeeds' },
      { id: 'ep-65', label: 'REDEMPTION (purchase): Female user applying a female-only purchase promo at checkout succeeds' },
      ...
      { id: 'ep-68', label: 'FIRST PURCHASE BONUS BACKEND: Despite the admin UI removal, the automatic first-purchase bonus still fires using the last-saved SiteConfig values (first_purchase_bonus_men/women_enabled and _tokens)' },
