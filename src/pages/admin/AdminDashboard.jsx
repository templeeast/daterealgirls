...
import { Users, Shield, Flag, HelpCircle, Settings, MapPin, ClipboardList, ImageIcon, ListTodo, Tag, Gift, FileText, Palette, TestTube, Database } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link to="/admin/test-accounts">
            <button className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground border rounded-lg px-3 py-2 transition-colors">
              <FileText className="w-4 h-4" /> Test Accounts
            </button>
          </Link>
          <Link to="/admin/todo">
            <button className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground border rounded-lg px-3 py-2 transition-colors">
          ...
          <Link to="/admin/bonuses-and-promos">
            <button className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground border rounded-lg px-3 py-2 transition-colors">
              <Gift className="w-4 h-4" /> Bonuses & Promos
            </button>
          </Link>
          <Link to="/admin/logo-assets">
            <button className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground border rounded-lg px-3 py-2 transition-colors">
              <Palette className="w-4 h-4" /> Logo Assets
            </button>
          </Link>
          <Link to="/admin/data-migration">
            <button className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground border rounded-lg px-3 py-2 transition-colors">
              <Database className="w-4 h-4" /> Data Migration
            </button>
          </Link>
        </div>
      </div>
