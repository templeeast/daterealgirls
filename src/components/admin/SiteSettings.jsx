...
export default function SiteSettings() {
  ...
  const [form, setForm] = useState({
    ...
    buymeacoffee_enabled_men: false,
    buymeacoffee_enabled_women: false,
    buymeacoffee_message_credit_cost: 5,
    photos_private_men_enabled: true,
    photos_private_women_enabled: true,
    tokens_wink_men_enabled: true,
    tokens_wink_cost_men: 5,
    tokens_wink_women_enabled: false,
    tokens_wink_cost_women: 0,
    wink_expiry_hours: 168,
    ...
    tokens_msg_photo_cost_women: 0,
    tokens_private_photo_cost: 5,
    tokens_private_photo_cost_women: 0,
    tokens_msg_video_cost_men: 10,
    tokens_msg_video_cost_women: 10,
    tokens_private_video_cost: 10,
    tokens_private_video_cost_women: 0,
    private_media_creator_share_percentage: 80,
    tokens_profile_privacy_toggle_cost: 100,
  ...
  useEffect(() => {
    if (existingConfig) {
      setForm({
        ...
        buymeacoffee_enabled_men: existingConfig.buymeacoffee_enabled_men || false,
        buymeacoffee_enabled_women: existingConfig.buymeacoffee_enabled_women || false,
        buymeacoffee_message_credit_cost: existingConfig.buymeacoffee_message_credit_cost ?? 5,
        photos_private_men_enabled: existingConfig.photos_private_men_enabled !== false,
        photos_private_women_enabled: existingConfig.photos_private_women_enabled !== false,
        ...
        wink_expiry_hours: existingConfig.wink_expiry_hours ?? 168,
        ...
        tokens_msg_photo_cost_women: existingConfig.tokens_msg_photo_cost_women ?? 0,
        tokens_private_photo_cost: existingConfig.tokens_private_photo_cost ?? 5,
        tokens_private_photo_cost_women: existingConfig.tokens_private_photo_cost_women ?? 0,
        ...
        tokens_private_video_cost_women: existingConfig.tokens_private_video_cost_women ?? 0,
        private_media_creator_share_percentage: existingConfig.private_media_creator_share_percentage ?? 80,
        tokens_profile_privacy_toggle_cost: existingConfig.tokens_profile_privacy_toggle_cost ?? 100,
